...
public abstract class ZegoBaseActivity extends AccessibilityActivity {
    ...
    protected abstract void onLoginRoomSuccess();
    ...
    protected void setEventHandler() {
        mEngine.setEventHandler(new IZegoEventHandler() {
            ...
            public void onRoomStreamUpdate(String roomID, ZegoUpdateType updateType, ArrayList<ZegoStream> streamList, JSONObject extendedData) {
                ...
                if (updateType == ZegoUpdateType.ADD) {
                    ...
                    ZegoBaseActivity.this.onRoomStreamUpdate(stream, playStreamID);
                }
            }
    ...
    //登录房间
    protected void loginRoom(String userId, String roomId) {
        ...
        // 登录房间
        mEngine.loginRoom(roomId, user, roomConfig, (int error, JSONObject extendedData)->{
